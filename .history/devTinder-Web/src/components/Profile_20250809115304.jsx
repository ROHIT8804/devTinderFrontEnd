  ...
  return (
    <div className="card card-border bg-base-100 w-96" style={{ backgroundColor: "#e0f2fe" }}>
      ...
      <div className="card-body">
        ...
        <div className="mt-2">
          <label className="input validator">
            <input type="email" value={gender} onChange={(e)=>setGender(e.target.value)} placeholder="Last Name" required />
          </label>
        </div>
        <div className="mt-2">
          <label className="input validator">
            <input type="email" value={photoUrl} onChange={(e)=>setPhotoUrl(e.target.value)} placeholder="Last Name" required />
          </label>
        </div>
