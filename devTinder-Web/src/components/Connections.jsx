...
const connections = () => {
  ...
  useEffect(() => {
    handleConnection();
    if((Array.isArray(connectionsData) && connectionsData.length === 0) || connectionsData === undefined || connectionsData === null){
      setNoRequestsMessage(("No more users available"));
    }
  }, []);

  if((Array.isArray(connectionsData) && connectionsData === 0) || connectionsData === undefined || connectionsData === null){
    return (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3 justify-center">
                  <button 
                    onClick={() => navigate(`/chat/${connectionData._id}`)}
                    className="px-6 py-2 bg-[#00a884] hover:bg-[#008f6f] text-white rounded-lg font-medium transition-colors duration-200 flex-1 flex items-center justify-center gap-2"
                  >
